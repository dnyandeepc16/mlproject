...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        '''
        The function is used for data transformation
        '''
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            logging.info("Obtaining preprocessing opbject")
            ...
            input_feat_train_df = train_df.drop(columns=[target_col_name], axis=1)
            target_feat_train_df = train_df[target_col_name]

            input_feat_test_df = test_df.drop(columns=[target_col_name], axis=1)
            target_feat_test_df = test_df[target_col_name]
